...
function BuildStructure()
{
  ...
  var header  = '<div class="header"><table class="hdr-table"><tr><td class="hdr-image"><a href="' + wDir + '/"><img src="' + wDir + '/static/ahk_logo_no_text.png" width="217" height="70" alt="AutoHotkey"></a></td><td class="hdr-search"><form id="search-form"><input id="q" size="30" type="text" placeholder="' + translate.hdSearchTxt + '"></form><div id="search-btn">' + translate.hdSearchBtn + '</div></td><td class="ahkv2e"><ul><li>Language<ul class="second"><li id="lng-btn-en">English</li><li id="lng-btn-de">Deutsch</li><li id="lng-btn-cn">&#20013;&#25991;</li></ul></li></ul></td></td><td class="ahkv2"><ul><li>ahk v 2.0<ul class="second"><li id="lng-btn-e">English</li><li id="lng-btn-d">Deutsch</li><li id="lng-btn-c">&#20013;&#25991;</li></ul></li></ul></td></td></li></ul></li></ul></td></tr></table></div>';
...
function AddContent()
{
  ...
  $(document).ready(function() {
    ...
    $('.ahkv2').on('click', function() { 
    window.open('https://lexikos.github.io/v2/docs/AutoHotkey.htm')
    });
    ...
    $('.hdr-table .ahkv2e').find('li').mouseenter(function() {
...
$(".jqtree_common.jqtree-title:contains('Usage and Syntax')").click(function(){
 $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 200;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Environment')").click(function(){
 $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 370;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('External Libraries')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
...
$(".jqtree_common.jqtree-title:contains('File, Directory and Disk')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 425;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Flow of Control')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 455;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Graphical User Interfaces')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
...
$(".jqtree_common.jqtree-title:contains('Maths')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 510;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Mouse and Keyboard')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 540;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Misc.')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 570;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Object Types')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
...
$(".jqtree_common.jqtree-title:contains('Process')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 625;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Registry')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 655;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Screen and Monitor')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 680;
  });
$(this).click();

$(".jqtree_common.jqtree-title:contains('Sound')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 710;
  });

$(".jqtree_common.jqtree-title:contains('String')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
...
$(".jqtree_common.jqtree-title:contains('Window')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 760;
  });

$(".jqtree_common.jqtree-title:contains('#Directives')").click(function(){
     $(".jqtree-toggler:contains('▼')").click();
     pause(100);
     document.body.scrollTop = document.documentElement.scrollTop = 795;
  });
...
$('#sidebar').click(function(){
  ...
  localStorage.setItem('myCat', height);
});
