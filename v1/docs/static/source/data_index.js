index = [
  ["#AllowSameLineComments","commands/+AllowSameLineComments.htm"],
  ["#ClipboardTimeout","commands/+ClipboardTimeout.htm"],
  ["#CommentFlag","commands/+CommentFlag.htm"],
  ["#Delimiter","commands/+EscapeChar.htm#Delimiter"],
  ["#DerefChar","commands/+EscapeChar.htm#DerefChar"],
  ["#ErrorStdOut","commands/+ErrorStdOut.htm"],
  ["#EscapeChar","commands/+EscapeChar.htm"],
  ["#HotkeyInterval","commands/+HotkeyInterval.htm"],
  ["#HotkeyModifierTimeout","commands/+HotkeyModifierTimeout.htm"],
  ["#Hotstring","commands/+Hotstring.htm"],
  ["#If","commands/+If.htm"],
  ["#IfTimeout","commands/+IfTimeout.htm"],
  ["#IfWinActive","commands/+IfWinActive.htm"],
  ["#IfWinExist","commands/+IfWinActive.htm"],
  ["#IfWinNotActive","commands/+IfWinActive.htm"],
  ["#IfWinNotExist","commands/+IfWinActive.htm"],
  ["#Include","commands/+Include.htm"],
  ["#IncludeAgain","commands/+Include.htm"],
  ["#InputLevel","commands/+InputLevel.htm"],
  ...
  ["#MaxHotkeysPerInterval","commands/+MaxHotkeysPerInterval.htm"],
  ["#MaxMem","commands/+MaxMem.htm"],
  ["#MaxThreads","commands/+MaxThreads.htm"],
  ["#MaxThreadsBuffer","commands/+MaxThreadsBuffer.htm"],
  ["#MaxThreadsPerHotkey","commands/+MaxThreadsPerHotkey.htm"],
  ["#MenuMaskKey","commands/+MenuMaskKey.htm"],
  ["#NoEnv","commands/+NoEnv.htm"],
  ["#NoTrayIcon","commands/+NoTrayIcon.htm"],
  ["#Persistent","commands/+Persistent.htm"],
  ["#SingleInstance","commands/+SingleInstance.htm"],
  ["#UseHook","commands/+UseHook.htm"],
  ["#Warn","commands/+Warn.htm"],
  ["#WinActivateForce","commands/+WinActivateForce.htm"],
  ...
  ["buffering","commands/+MaxThreadsBuffer.htm"],
  ...
  ["Delimiter","commands/+EscapeChar.htm"],
  ["DerefChar","commands/+EscapeChar.htm"],
  ...
  ["ErrorStdOut","commands/+ErrorStdOut.htm"],
  ["escape sequence","commands/+EscapeChar.htm"],
  ["EscapeChar","commands/+EscapeChar.htm"],
  ...
  ["tray icon","commands/+NoTrayIcon.htm"],
  ...
  ["variants (duplicate hotkeys and hotstrings)","commands/+IfWinActive.htm#variant"],
